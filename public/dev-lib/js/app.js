...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    initEmptyProd: function initEmptyProd() {
      this.product = this.clone(ProductRef);
    },
    onTableHeaderClick: function onTableHeaderClick(header) {
    ...
    getProdTypesList: function getProdTypesList() {
      axios.get('/products/get-prod-types-list').then(function (response) {
        this.productTypesList = response.data;
      }.bind(this));
    },
    getProdsList: function getProdsList() {
      this.updating = true;
      axios.get('/products/get-prods-list', {
        params: {
          page: this.page,
    ...
    addNewProduct: function addNewProduct() {
      ...
      axios.post('/products/add-new-product', formData, {
        headers: {
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "container", attrs: { id: "productsList" } },
    [
      _c("div", { staticClass: "row" }, [
                  ...
                  directives: [
                    {
                      name: "show",
                      rawName: "v-show",
                      value: _vm.mode === "add_new",
                      expression: "mode === 'add_new'"
                    }
                  ],
                  staticClass: "col-12"
                },
                            ...
                            _c("div", { staticClass: "col-md-8" }, [
                              _c("div", { staticClass: "form-group" }, [
                                ...
                                _c(
                                  ...
                                  _vm._l(_vm.productTypesList, function(type) {
                                    return _c(
                                      "option",
                                      {
                                        key: type.id,
                            ...
                            _c("div", { staticClass: "col-md-3" }, [
                              _c("div", { staticClass: "form-group" }, [
                                ...
                                _c("input", {
                                  ...
                                  domProps: { value: _vm.product.cost },
                                  on: {
                                    input: function($event) {
                                      if ($event.target.composing) {
                                        return
        ...
        _c("div", { staticClass: "col-12" }, [
          _c("div", { staticClass: "row" }, [
            _c("div", { staticClass: "col-md-3" }, [
              _c("div", { staticClass: "form-group" }, [
                _c("label", { attrs: { for: "prodTypeFilter" } }, [
                  _vm._v("Show by type")
                ]),
                _vm._v(" "),
                _c(
                    ...
                    on: {
                      change: [
                        function($event) {
                          ...
                          _vm.byType = $event.target.multiple
                            ? $$selectedVal
                            : $$selectedVal[0]
                        },
                        _vm.getProdsList
        ...
        _vm._v(" "),
        _vm.prodsList.length > 0
          ? _c(
              "div",
              { staticClass: "col-12 table-responsive table-full-width" },
              [
                _c(
                  "table",
                  { staticClass: "table table-hover table-striped sortable" },
                  [
                    _c(
                      "thead",
                    ...
                    _c(
                      "tbody",
                      _vm._l(_vm.prodsList, function(prod) {
                        return _c("tr", { key: prod.id }, [
                          ...
                          _c("td", [
                            _c("img", {
                              ...
                              attrs: { src: prod.image_url, alt: "prod image" }
                            })
                          ]),
                          _vm._v(" "),
                          _c("td", [_vm._v(_vm._s(prod.name))]),
                          _vm._v(" "),
                          _c("td", [_vm._v(_vm._s(prod.type.name))]),
                          _vm._v(" "),
                          _c("td", [_vm._v("$" + _vm._s(prod.cost))]),
                          _vm._v(" "),
                          _c("td", [_vm._v(_vm._s(prod.weight) + " g.")])
                        ])
                      }),
                      0
                    )
          ...
          _c("div", { staticClass: "row" }, [
            _c(
              ...
              [
                _c("paginate", {
                  attrs: {
                    "page-count": _vm.pagesCount,
                    "page-range": _vm.pageRange,
                    "margin-pages": _vm.marginPages,
                    "click-handler": _vm.getProdsList,
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("span", { staticClass: "list-update top" }, [
      _c("i", { staticClass: "fa fa-spinner anim-rotate" })
    ])
  }
]
...
Vue.component('products-list', __webpack_require__(/*! ./components/ProductsList.vue */ "./resources/js/components/ProductsList.vue")["default"]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    notifyInfo: function notifyInfo(message) {
      var timer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 10000;
      this.notify({
        icon: 'pe-7s-info',
        message: message,
        type: 'info',
    ...
    notifyWarning: function notifyWarning(message) {
      var timer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 8000;
      this.notify({
    ...
    notify: function notify(options) {
      var placementData = this.notifyPlacements(this.notifyPosition);
      $.notify({
        icon: options.icon,
    ...
    notifyPlacements: function notifyPlacements(position) {
      switch (position) {
        case 'top-left':
          {
            return {
...
__webpack_require__(/*! D:\OpenServer\domains\pizza-app\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\OpenServer\domains\pizza-app\resources\sass\style.scss */"./resources/sass/style.scss");
